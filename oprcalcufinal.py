...
f1 = open('OPRdocument.txt', 'w')
for i in range (0, length):
	print (data[i]["alliances"]["red"]["team_keys"][0],", ", data[i]["alliances"]["red"]["team_keys"][1],", ", data[i]["alliances"]["red"]["team_keys"][2],", ", data[i]["alliances"]["red"]["score"],", ", data[i]["alliances"]["blue"]["team_keys"][0],", ", data[i]["alliances"]["blue"]["team_keys"][1],", ", data[i]["alliances"]["blue"]["team_keys"][2],", ", data[i]["alliances"]["blue"]["score"],file = f1)
f1.flush()


#f1 = open('OPRdocument.txt', 'w')
#for comp_level in ev.getMatchData():
#	print (ev.getMatchData()[comp_level]["alliances"]["red"]["team_keys"][0],", ", ev.getMatchData()[comp_level]["alliances"]["red"]["team_keys"][1],", ", ev.getMatchData()[comp_level]["alliances"]["red"]["team_keys"][2],", ", (ev.getMatchData()[comp_level]["score_breakdown"]["red"]["totalPoints"]),", ", ev.getMatchData()[comp_level]["alliances"]["blue"]["team_keys"][0],", ", ev.getMatchData()[comp_level]["alliances"]["blue"]["team_keys"][1],", ", ev.getMatchData()[comp_level]["alliances"]["blue"]["team_keys"][2],", ", (ev.getMatchData()[comp_level]["score_breakdown"]["blue"]["totalPoints"]),file = f1)
#f1.flush()


with open('OPRdocument.txt') as csv_file:
